...
- `cd mobile && npm install` then `npm test`: **26 suites / 361 tests, all passing** (re-verified
  2026-09-12 via `npx jest`) — grown well past the 4 suites / 77 tests changelog #080 originally
